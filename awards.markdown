...
<ul style="list-style-type: none; padding-left: 0;">
  ...
  <li style="margin-bottom: 10px;">
    <strong>Poster Award</strong> – for poster on "Joint Bayesian estimation of cell dependence and gene associations in spatially resolved transcriptomic data", awarded by the 6th Annual Symposium Cancer Research
  </li>
  <li style="margin-bottom: 10px;">
...
<ul style="list-style-type: none; padding-left: 0;">
  <li style="margin-bottom: 10px;">
    <strong>Gold Medal in M.Sc. Statistics</strong> – awarded for being the University Topper <span style="float:right;"><em>2016</em></span>
  </li>
  <li style="margin-bottom: 10px;">
